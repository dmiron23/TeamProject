...
import test.graphics.BoxedText;
import test.graphics.GraphicsObject;
import test.graphics.Label;
import test.graphics.Rectangle;
import test.graphics.Line;
...
public class canvas extends JPanel implements MouseMotionListener{
	...
	public void setupListeners(){								//Listeners are used to execute functions on events.
		addMouseMotionListener(this);						//Timer to step animation.
	}
